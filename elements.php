		...
		<div class="container-fluid">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="header-right col-lg-6 col-md-6">
					...
					<p class="pt-20">
						Biro Perjalanan dan Wisata <br> GMS: 085259598097 <br>
			...
			<div class="row align-items-center justify-content-center">
				<div class="col-lg-5 offset-lg-1">
					<div class="left-content">
						<img class="img1 img-fluid" src="img/popular/leana/lna1.jpg" alt="">
						<img class="img2 img-fluid" src="img/popular/leana/lna2.jpg" alt="">
						<img class="img3 img-fluid" src="img/popular/leana/lna3.jpg" alt="">
					</div>
				</div>
				<div class="col-lg-5 offset-lg-1">
					<div class="right-content">
						<div class="main_title">
							<h1>Tentang Kami</h1>
							<p><h3>Kontak TELEPON</h3></p>
<b>(0353) 98097
085259598097</b>
<h3>Alamat</h3>
Jln. Raya Tanjung Harjo 137.
Bojonegoro
Kabupaten Bojonegoro
Jawa Timur 62115
Indonesia<br>

<h3>Leana Tour & Travel</h3> 
Halaman : <a href="https://www.facebook.com/Leana-Tour-Travel-387295591346837/">Leana Tour Travel</a>
						</div>
