		...
		<div class="container-fluid">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="header-right col-lg-6 col-md-6">
					<h1>
						Sepinggan Indah Tour-Travel-Ticket
					</h1>
					<p class="pt-20">
						Biro Perjalanan dan Wisata <br> GMS: 082334203839
			...
			<div class="row align-items-center justify-content-center">
				<div class="col-lg-5 offset-lg-1">
					<div class="left-content">
						<img class="img1 img-fluid" src="img/popular/sepinggan/spg1.jpg" alt="">
						<img class="img2 img-fluid" src="img/popular/sepinggan/spg3.jpg" alt="">
						<img class="img3 img-fluid" src="img/popular/sepinggan/spg2.jpg" alt="">
					</div>
				</div>
				<div class="col-lg-5 offset-lg-1">
...
<h3>Sepinggan Indah Tour & Travel</h3>
Halaman : <a href="https://sepinggan-indah-tour-travel-ticket.business.site/">Sepinggan Indah Tour Travel</a> <br>
<h3>Maps</h3>
<a href="https://www.google.com/maps/dir//SEPINGGAN+INDAH+Tour-Travel-Ticket/@-7.1659867,111.8189184,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x2e778193b48e9169:0xa166a1baae63f9fe!2m2!1d111.888959!2d-7.165992">Dapatkan petunjuk arah</a>
						</div>
						<div class="counter_area">
							...
							<div class="single_counter">
									...
									<div class="info-content">
										<a  href="http://localhost/Travel/tugas_akhir/page.php?id=6"> <h4>Paket Wisata Dander</h4></a>
										<p>Rp.200.000</p>
									</div>
								</div>
								<!-- single counter -->
								<div class="single_counter">
									...
									<div class="info-content">
									<a href="http://localhost/Travel/tugas_akhir/page.php?id=4">	<h4>Paket Wisata Ngasem</h4></a>
										<p>Rp.200.0000</p>
									</div>
								</div>
							</div>
							...
							<div class="bottom-two">
								...
								<div class="single_counter">
									...
									<div class="info-content">
									<a href="http://localhost/Travel/tugas_akhir/page.php?id=5">	<h4>Paket Wisata Temayang</h4></a>
										<p>Rp.200.000</p>
									</div>
								</div>
								<!-- single counter -->
								<div class="single_counter">
									...
									<div class="info-content">
										<a href="http://localhost/Travel/tugas_akhir/page.php?id=2"><h4>Paket Wisata Kalitidu</h4></a>
										<p>Rp.200.000</p>
									</div>
								</div>
							</div>
