                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                       <a class="dropdown-item" href="about-us.php">Sepinggan Indah Tour-Travel-Ticket</a>
                        <a class="dropdown-item" href="amenities.php">Ahya & Travel</a>
        ...
        <div class="container-fluid">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="header-right col-lg-6 col-md-6">
                    ...
                    <p class="pt-20">
                        Nama  : Veri Junia Putra <br>
                        TTL   : Tangerag,27 Juni 1998<br>
                        Alamat:Ds. Kapas Kec.Kapas Kab.Bojonegoro<br><br>
                          Nama saya adalah Veri Junia Putra, Lahir di Tangerang, 27 Juni 1998, saya adalah anak ketiga dari dari bersaudara, Fery adalah panggilan akrab saya, saya terlahir di keluarga yang sangat sederhana, Ayah saya seorang Pegawai Swasta di daerah Kalimantan Selatan, sedangkan Ibu saya bekerja sebagai ibu rumah tangga. Sejak kecil dia selalu di nasehati oleh ayahnya untuk selalu rajin beribadah, jujur dan baik terhadap sesama.
                ...
                <div class="col-lg-6 col-md-6 header-left">
                    <div class="">
                        <img class="img-fluid w-100" src="img/blog/main-blog/mblog.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-3">
                    <div class="contact_info">
                        <div class="info_item">
                          ...
                          <h6><a href="https://www.facebook.com/fery.amatir">Facebook</a></h6>
                            <p>Fery June</p>
                        </div>
                        <div class="info_item">
                            <i class="lnr lnr-phone-handset"></i>
                            <h6><a href="https://api.whatsapp.com/send?phone=082229086263">Kontak</a></h6>
                            <p>082229086263</p>
                        </div>
                        <div class="info_item">
                            <i class="lnr lnr-envelope"></i>
                            <h6><a href="#">Email</a></h6>
                            <p>Feryjune6@gmail.cm</p>
                        </div>
                    </div>
                </div>
            </div>
