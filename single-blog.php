...
$link = mysqli_connect("localhost","root","","db_travel");
    ...
    $sql = "SELECT * FROM tabel_postingan ORDER BY id_post DESC ";
...
<body>
  ...
  <div class="side_menu">
    ...
    <?php 
    $sql_new = "SELECT * FROM tabel_postingan ORDER BY tgl_posting LIMIT 1";
    $result_new = mysqli_query($link, $sql_new);

        if ($row_new= mysqli_num_rows($result_new) > 0) {
        while ($data_new = mysqli_fetch_array($result_new)) {
    ?>
        ...
        <div class="container-fluid">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="header-right col-lg-6 col-md-6">
                    <h1>
                        <?php echo $data_new['judul_postingan'];?>
                    </h1>
                    <p class="pt-20">
                        <?= $data_new['deskripsi'];?>
                    </p>
                ...
                <div class="col-lg-6 col-md-6 header-left">
                    <div class="">
                        <img class="img-fluid w-100" src="<?= $data_new['foto_konten'];?>" alt="">
                    </div>
                    <div class="video-popup d-flex align-items-center">
                        <a class="play-video video-play-button animate" href="<?= $data_new['video']; ?>"
